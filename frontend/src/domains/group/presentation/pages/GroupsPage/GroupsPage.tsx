    ...
    <div className="groups-page">
      ...
      <header className="groups-page__header">
        <div className="groups-page__title-area">
          ...
          <p>
            Organise your requests using the{" "}
            <strong>Composite pattern</strong>. Groups can contain requests
            and sub-groups; <code>count()</code> and <code>flatten()</code>{" "}
            propagate recursively through the entire tree.
          </p>
        </div>
